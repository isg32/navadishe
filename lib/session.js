// Shared helpers for the dashboard's cookie-based session, used by the
// login/logout/whoami/leads/analytics/users/sync-sheets route handlers and
// by middleware.js. Uses only Web Crypto / Web APIs (available in both the
// Edge runtime middleware runs on and the Node runtime route handlers use)
// so there's no dependency to bundle.
