// Vercel Edge Function — writes registrations straight to Neon Postgres
// (source of truth). Google Sheets is now only touched by api/sync-sheets.js,
// an explicit admin action, not on every submission.
//
